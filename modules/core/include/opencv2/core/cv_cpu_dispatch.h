...
#if defined(__PPC64__) && defined (__ALTIVEC__) && defined(__VSX__) && defined(__LITTLE_ENDIAN__)
#  include <altivec.h>
#undef vector
#undef pixel
#undef bool
...
#  include <arm_neon.h>
#  define CV_NEON 1
#elif defined(__PPC64__) && defined (__ALTIVEC__) && defined(__VSX__) && defined(__LITTLE_ENDIAN__)
#  include <altivec.h>
#undef vector
#undef pixel
#undef bool
